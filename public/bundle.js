	    ...
	    React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            IndexLink,
	            { to: '/', activeClassName: 'active', style: navStyle, activeStyle: activeStyle },
	            'Get Weather'
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            IndexLink,
	            { to: '/about', activeClassName: 'active', style: navStyle, activeStyle: activeStyle },
	            'About'
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            IndexLink,
	            { to: '/examples', activeClassName: 'active', style: navStyle, activeStyle: activeStyle },
	            'Examples'
	          )
	        )
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherResult = __webpack_require__(225);
	var openWeatherMap = __webpack_require__(226);
	  ...
	  render: function render() {
	    ...
	    function renderMessage() {
	      if (message.isLoading) {
	        ...
	        return React.createElement(WeatherResult, { message: message });
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _URL = "http://api.openweathermap.org/data/2.5/weather?appid=89fd9b4ed3bd4d646eda2c70cc0b62f8&units=metric";
